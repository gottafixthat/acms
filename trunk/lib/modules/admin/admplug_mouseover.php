<?php
/**
 * admplug_mouseover.php - The admin module for mouseovers.
 *
 **************************************************************************
...
if (eregi('admplug_mouseover.php', $_SERVER['PHP_SELF'])) die ("This file may not be loaded directly.");

// The global variables we use to load ourselves into.
global $admplugins;


// The admplugin_mouseover class.
class admplugin_mouseover {
...
/*
** admplugin_mouseover - Constructor.  This handles the setup of the various admin
**                  functions of this plugin.
*/

function admplugin_mouseover()
{
    // Get the template file name.
    $parts = pathinfo(__FILE__);
    $this->templatePath = $parts["dirname"] . "/admplug_";
    $this->pluginName   = "mouseover";
...
} // admplugin_mouseover constructor
...
function showEditForm($act = "edit")
{
    ...
    $tpl = new acmsTemplate($this->templatePath . "mouseover_edit_form.tpl");
    ...
    $app->addBlock(10, CONTENT_ZONE, "Edit Mouseover Chunk", $tpl->get());
}
...
function loadChunk($ChunkID)
{
    ...
    $cc = new chunkClass("mouseover");

    if (!$cc->fetchID($ChunkID)) {
        $app->addBlock(0, CONTENT_ZONE, "Admin - Edit Mouseover Chunks", "Unable to load the specified chunk.");
        return false;
    }
...
function processEdit()
{
    ...
    if (!$this->ChunkID) {
        ...
        // Make sure the chunk that we are replacing is a mouseover chunk.
...
};  // admplugin_mouseover class

$admplugins['mouseover'] = new admplugin_mouseover();
?>
