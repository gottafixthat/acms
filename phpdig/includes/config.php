...
define('ABSOLUTE_SCRIPT_PATH','/shared/acms/phpdig'); // up to but not including admin dir
...
//http://www.domain.com/dirs/ (WITH ending slash) or http://www.domain.com/dirs/index.php
...
define('CRON_CONFIG_FILE', '/full/path/to/dir/cronfile.txt');
define('PHPEXEC','/usr/local/bin/php');
// NOTE: make sure to check that the first if statement in this file allows the full path up to the admin dir
...
// From shell: crontab CRON_CONFIG_FILE -u to set the cron job - replace CRON_CONFIG_FILE with actual file
